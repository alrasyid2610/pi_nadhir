...
<div class="row">
    <div class="col-md-12 col-sm-12 ">
			<div class="x_panel">
				<div class="x_title">
          <h2>Data Daftar Artikel</small></h2>
            ...
            <div class="row">
              ...
              @foreach ($data_artikel as $item)
                <div class="col-12 col-sm-8 col-md-6 col-lg-3">
                  <div class="card">
                    <a href="{{ route('artikel.show', $item->id) }}" class="d-block" style="position: relative">
                      <img class="card-img post-thumbnail" src="{{ asset('/images_article/' . $item->img_banner) }}" alt="Bologna">
                      <a href="goole.com" class="btn btn-success btn-sm tag-artikel">{{ $item->category }}</a>
